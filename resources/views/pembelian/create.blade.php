            ...
            <div class="card">
                <div class="card-body">
                    ...
                    <div class="form-group">
                        ...
                        @error('nonota_beli') is-invalid @enderror" id="nonota_beli" placeholder="Masukan Nomor Nota"
                    ...
                    <div class="form-group">
                        ...
                        <input type="datetime-local" class="form-control 
                            @error('tgl_beli') is-invalid @enderror" id="tgl_beli" readonly
                            placeholder="Masukkan Tanggal" name="tgl_beli" value="{{date('Y-d-m H:i:s') ?? old('tgl_beli')}}">
                    ...
                    <div class="form-group">
                        ...
                        <div class="input-group">
                            ...
                            <button class="btn btn-warning" type="button" data-bs-toggle="modal" id="cari"
                                data-bs-target=#staticBackdrop>Cari Data distributor</button>
                        </div>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <input type="double" class="form-control 
                            @error('total_beli') is-invalid @enderror" id="total_beli" value="0" readonly
                            placeholder="Masukan Total" name="total_beli" value="{{old('total_beli')}}">
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <button type="button" class="btn btn-primary 
                                                    btn-xs"
                                                    onclick="pilih1('{{$distributor->id}}', '{{$distributor->nama_distributor}}', '{{$distributor->alamat}}', '{{$distributor->notelepon}}')"
                ...
                <div class="modal fade" id="staticBackdrop1" data-bsbackdrop="static" data-bs-keyboard="false"
                    ...
                    <div class="modal-dialog modal-lg modal-dialog-scrollable p-5">
                        <div class="modal-content">
                            <div class="modal-header">
                                <h1 class="modal-title fs-5" id="staticBackdropLabel1">Pencarian Data User</h1>
                                <button type="button" class="btn-close" data-bs-dismiss="modal"
                                    aria-label="Close"></button>
                            </div>
                            <div class="modal-body">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <button type="button" class="btn btn-primary 
                                                    btn-xs"
                                                    onclick="pilih2('{{$user->id}}', '{{$user->name}}', '{{$user->email}}', '{{$user->level}}', '{{$user->aktif}}' )"
                                                    data-bs-dismiss="modal">
                                                    Pilih
                                                </button>
                                            </td>
